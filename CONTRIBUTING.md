...
Contributions to **FlorianWolters\Component\Geometry** are always welcome.
...
Run the following commands to initially checkout **FlorianWolters\Component\Geometry**:

    md Geometry && cd Geometry
    git clone git://github.com/FlorianWolters/PHP-Component-Geometry.git
