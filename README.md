...
[![Build Status](https://secure.travis-ci.org/FlorianWolters/PHP-Component-Geometry.png?branch=master)](http://travis-ci.org/FlorianWolters/PHP-Component-Geometry)

**FlorianWolters\Component\Geometry** is a simple-to-use [PHP][17] component that offers models and operations on objects related to geometry.
...
The best documentation for **FlorianWolters\Component\Geometry** are the unit tests, which are shipped in the package. You will find them installed into your [PEAR][10] repository, which on Linux systems is normally `/usr/share/php/test`.

## Installation

### Local Installation

**FlorianWolters\Component\Geometry** should be installed using the dependency manager [Composer][3]. [Composer][3] can be installed with [PHP][6].
...
**FlorianWolters\Component\Geometry** should be installed using the [PEAR installer][11]. This installer is the [PHP][17] community's de-facto standard for installing [PHP][17] components.
...
[1]: http://florianwolters.github.com/PHP-Component-Geometry
